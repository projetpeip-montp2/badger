...
IF (WIN32)
	...
	IF(MYSQL_LIB)
		SET(MYSQLCPP_DYNLOAD_MYSQL_LIB MYSQL_LIB)
		GET_FILENAME_COMPONENT(MYSQL_LIB_DIR ${MYSQL_LIB} PATH)
	ENDIF(MYSQL_LIB)
	ADD_DEFINITIONS("-DDYNLOAD_MYSQL_LIB=\"${MYSQLCPP_DYNLOAD_MYSQL_LIB}\"")
ELSE (WIN32)
	IF (MYSQL_CONFIG_EXECUTABLE)
		...
		FIND_LIBRARY(MYSQLCPP_DYNLOAD_MYSQL_LIB NAMES mysqlclient_r
					 PATHS
...
IF (MYSQL_INCLUDE_DIR AND MYSQL_LIB_DIR)
	...
	MESSAGE(STATUS "MySQL CXXFLAGS: ${MYSQL_CXXFLAGS}")
	MESSAGE(STATUS "MySQL Link flags: ${MYSQL_LINK_FLAGS}")
	MESSAGE(STATUS "MySQL dynamic load test library: ${MYSQLCPP_DYNLOAD_MYSQL_LIB}")
	#IF(MYSQLCPP_DYNLOAD_MYSQL_LIB)
		#ADD_DEFINITIONS("-DDYNLOAD_MYSQL_LIB=\"${MYSQLCPP_DYNLOAD_MYSQL_LIB}\"")
	#ENDIF(MYSQLCPP_DYNLOAD_MYSQL_LIB)
